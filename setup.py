...
project_config = {
    "meta":{
        "name":"vsco-batch-dl", # Project name
        "description":"A script for downloading a batch of images from VSCO", # Project description
        "readme_file":"README.md", # Filepath for project README (blank for none)
        "version":"1.0",
        "license":"GPLv3",
        "url":"https://github.com/Ewpratten/vsco-batch-dl",
        "author":{
            "name":"Evan Pratten",
    ...
    "module_info":{
        "path":"vsco_batch_dl", # Module path
        "is_script": True, # If true, this module is a console script
        "entrypoints":["vsco-batch-dl = vsco_batch_dl:__main__:main"], # Fill this with any entrypoints for console script
